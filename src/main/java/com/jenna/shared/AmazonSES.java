...
public class AmazonSES {
   ...
   final String FROM = "wodms2020@gmail.com";
   ...
   final String HTMLBODY = "<h1>Please verify your email address</h1>"
         ...
         + "<a href='http://localhost:8080/my-restful-web-app/users/email-verification?token=$tokenValue'>"
   ...
   final String TEXTBODY = "Please verify your email address. "
         ...
         + " http://localhost:8080/my-restful-web-app/users/email-verification?token=$tokenValue"
         + " Thank you! And we are waiting for you inside!";
   ...
   public void verifyEmail(UserDTO userDto) {
      ...
      //Make sure Regions should be the one where your verified email is registered in AWS
      ...
      // Amazon SDK will send this request to AWS SES to deliver the email
